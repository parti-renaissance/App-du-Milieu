...
def get_colors(
    ...
    return df.merge(get_nuance_color(election), how="left")[
        ["code", dict_base[election], "code_couleur"]
    ]
...
def get_nuance_results(
    db: Session, scope: dict, election: str, tour: int, maillage: str, nuance: str
) -> pd.DataFrame:
