...
def translate_text(text: str, from_language: str = "FR", target_lang: str = "EN"):
    payload = {
...
def generate_text(text: str, from_language: str = "FR"):
    # Translate text to EN
    if from_language != "EN":
        translated = translate_text(
            text, from_language=from_language, target_lang="EN"
        )["translations"][0]
    else:
        translated = text
